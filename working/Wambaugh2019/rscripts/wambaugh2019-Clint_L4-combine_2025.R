#------------------------------------------------------------------------------#
## Combining the L4 Wambaugh2019 Clint Data ##
#-----------------------------------------------------------------------------#
## NOTE: This script is meant to be run programmatically via the following
##  command in the bash command line terminal:
##  `R CMD BATCH --vanilla wambaugh2019-Clint_L4-combine_2025.R wambaugh2019-Clint_L4-combine_2025_MMDDYYYY.Rout`
...
chemsplit_files <- list.files(here::here("data"),pattern = "Clint.+Level4Analysis")
